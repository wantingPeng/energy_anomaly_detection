    ...
    def _save_results(self, results):
        ...
        for i, result in enumerate(results, 1):
          ...
          for label in ['0', '1']:
              ...
              md_content += f"{label:>8}        {metrics['precision']:.4f}    {metrics['recall']:.4f}    {metrics['f1-score']:.4f}    {metrics['support']:>8}\n"
          md_content += f"\naccuracy                            {report['accuracy']:.4f}    {report['macro avg']['support']:>8}\n"
          md_content += f"macro avg        {report['macro avg']['precision']:.4f}    {report['macro avg']['recall']:.4f}    {report['macro avg']['f1-score']:.4f}    {report['macro avg']['support']:>8}\n"
          md_content += f"weighted avg     {report['weighted avg']['precision']:.4f}    {report['weighted avg']['recall']:.4f}    {report['weighted avg']['f1-score']:.4f}    {report['weighted avg']['support']:>8}\n"
          md_content += "\n```\n\n"
