...
class XGBoostOptunaTuner:
    ...
    def objective(self, trial):
        ...
        try:
            ...
            # Always calculate point adjustment metrics for comprehensive evaluation
            ...
            # Store adjusted metrics in val_metrics for consistency
            val_metrics['adj_accuracy'] = adj_accuracy
            val_metrics['adj_precision'] = adj_precision
            val_metrics['adj_recall'] = adj_recall
            val_metrics['adj_f1'] = adj_f1
            ...
            logger.info(f"Trial {trial.number}: "
                       ...
                       f"Adj-F1={val_metrics['adj_f1']:.4f}, Adj-Prec={val_metrics['adj_precision']:.4f}, "
                       f"Adj-Rec={val_metrics['adj_recall']:.4f} | Optimizing {self.optimization_metric}={optimization_value:.4f}")
