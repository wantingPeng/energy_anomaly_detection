...
if __name__ == "__main__":
    # ====== Customize below ======
    parquet_file = "Data/interim/Energy_labeling_windowFeatures/Kontaktieren_labeled.parquet"
    sample_output_csv = "Data/data_preview/Kontaktieren_windowFeatures_preview.csv"
    # ====== ================== ======
