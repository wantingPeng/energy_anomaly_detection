...
if __name__ == "__main__":
    # ====== Customize below ======
    parquet_file = "Data/interim/Anomaly_Data/Duration_of_Anomalies_cleaned.parquet"
    sample_output_csv = "/home/wanting/energy_anomaly_detection/Data/row/anomaly_data_cleaned_preview.csv"
    # ====== ================== ======
